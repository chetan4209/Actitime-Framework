...
public class TC_08 {
	...
	@FindBy(xpath="//div/span[contains(.,'Customer8')]")
	...
	@FindBy(xpath="//div[contains(text(),'Select target project to move task to:')]/following::div[contains(text(),'Galaxy Corporation')]")
	...
	@FindBy(xpath="//div[@class='ok button'][contains(text(),'Move')]")
